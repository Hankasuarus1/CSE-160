...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // Don't delete the return statement.
        v3 = new Vector3([
        other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1],  // x
        other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2],  // y
        other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0]   // z
    ]);
        return v3;
    }
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        let m = this.magnitude(); // Modify this line to calculate this vector's magnitude and use it to normalize this vector.
        // Don't delete the return statement.
        this.elements[0] /= m;
        this.elements[1] /= m;
        this.elements[2] /= m;
